...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train a genre classification model with the GTZAN dataset"
    )
    parser.add_argument(
        "path",
        type=str,
    ...
    parser.add_argument(
        "output_filename",
        type=str,
        help="Output filename for the trained model (current implementation works with the name genre.pt)",
    )
